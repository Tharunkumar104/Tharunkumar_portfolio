    ...
    <section id="home" className={styles.hero}>
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <h1 className={styles.name}>Tharunkumar D</h1>
          <p className={styles.title}>Instrumentation Engineer</p>

          <p className={styles.description}>
            Blending hardware automation with software development to build practical, 
            impact-driven solutions. From PLC/SCADA systems to React applications — 
            designing robust systems that solve real problems.
          </p>
          ...
          <div className={styles.socials}>
            ...
            <a 
              href="mailto:tharunkumar10406@gmail.com" 
              className={styles.socialLink}
              aria-label="Email"
            >
              <EmailIcon />
